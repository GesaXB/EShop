# Generated by Django 4.2 on 2024-12-17 16:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('store', '0002_alter_gallery_options_alter_gallery_gallery_id_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(blank=True, choices=[('Paypal', 'Paypal'), ('Stripe', 'Stripe'), ('Indonesia Bank Account', 'Indonesia Bank Account'), ('Indian Bank Account', 'Indian Bank Account'), ('USA Bank Account', 'USA Bank Account')], max_length=50, null=True)),
