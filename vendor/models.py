...
PAYOUT_METHOD = (
  ("Paypal", "Paypal"),
  ("Stripe", "Stripe"),
  ("Indonesia Bank Account", "Indonesia Bank Account"),
...
class Vendor(models.Model):
  ...
  vendor_id = ShortUUIDField(length=6, max_length=20, alphabet="1234567890", unique=True)
...
class Payout(models.Model):
  ...
  payout_id = ShortUUIDField(length=6, max_length=10, alphabet="1234567890", unique=True)
  date = models.DateTimeField(auto_now_add=True)
