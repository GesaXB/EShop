...
class Product(models.Model):
  ...
  sku = ShortUUIDField(unique=True, length=6, max_length=50, prefix="SKU", alphabet="1234567890")
...
class Gallery(models.Model):
  ...
  gallery_id = ShortUUIDField(length=6, max_length=10, alphabet="1234567890", unique=True)
...
class Order(models.Model):
  ...
  # addres = models.ForeignKey("customers.Addres", on_delete=models.SET_NULL, null=True)
  coupons = models.ManyToManyField(Coupon, blank=True)
  order_id = ShortUUIDField(max_length=25, alphabet="1234567890")
...
class OrderItem(models.Model):
  ...
  item_id = ShortUUIDField(max_length=25, alphabet= "1234567890")
